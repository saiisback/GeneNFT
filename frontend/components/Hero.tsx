...
export default function Hero() {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-black subtle-pattern">
      {/* Background Elements */}
      <AnimatedBlob />
      ...
      <div className="relative z-10 text-center px-4 max-w-6xl mx-auto">
        ...
        >
          ...
          <h1 className="text-6xl md:text-8xl font-elegant font-black text-white mb-6 tracking-wider">
            <span className="gradient-text">GENE</span>
            <span className="gradient-text-accent">NFT</span>
          </h1>
          
          {/* Subtitle with Cursive Font */}
          <p className="text-xl md:text-2xl font-cursive text-white/90 max-w-3xl mx-auto leading-relaxed font-medium">
        ...
        >
          <motion.div 
            ...
            transition={{ type: "spring", stiffness: 300 }}
          >
            <div className="text-4xl font-elegant font-bold gradient-text mb-2">1000+</div>
          ...
          <motion.div 
            ...
            transition={{ type: "spring", stiffness: 300 }}
          >
            <div className="text-4xl font-elegant font-bold gradient-text-accent mb-2">500+</div>
          ...
          <motion.div 
            ...
            transition={{ type: "spring", stiffness: 300 }}
          >
            <div className="text-4xl font-elegant font-bold gradient-text-gold mb-2">50+</div>
